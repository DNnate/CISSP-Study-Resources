...
- 8.2.1 Programming languages
    ...
    - ⚒️**High-level\Compiled languages (GEN 3)** Third-generation programming languages, such as C/C++, Java, and Python, are known as high-level languages. Generation three is for high-level languages, such as C. Compilers take this language and transition it to machine language. Compiled languages use a compiler to generate an executable file.
