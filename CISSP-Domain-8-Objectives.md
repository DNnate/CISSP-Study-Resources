...
- 🐍**Data Lake**: a data warehouse incorporating multiple types of streams of unstructured or semi-structured data. Data warehousing and data lakes have the purpose of having data that is analyzable.
...
- ❄️**Network database model**: database model in which data elements and records are arranged in arbitrary linked fashion (.e.g lists, clusters, or other network forms)
...
- 8.2.1 Programming languages
    ...
    - ⚒️**Compiled language**: converts source code into machine-executable format
        ...
        - C, c++,  Erlang, Haskell, Rust, Go, and Fortran are all compiled programming languages. Compiled languages use a compiler to generate an executable file.
