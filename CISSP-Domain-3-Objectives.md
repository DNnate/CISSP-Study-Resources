...
- 3.6.2 Cryptographic methods (e.g., symmetric, asymmetric, elliptic curves, quantum)
    - 🔴**Symmetric** encryption: uses the same key for encryption and decryption
        ...
        - total number of keys required to completely connect n parties using symmetric cryptography is given by this formula: 
            ...
            - ❄️**Block Ciphers**: Block ciphers operate on message "chunks" rather than on individual characters or bits.  Encrypts data in fixed-size blocks (e.g., 64 bits, 128 bits). Examples: DES, 3DES, AES, Blowfish, Twofish. Block ciphers can operate in various modes to enhance security and applicability:
