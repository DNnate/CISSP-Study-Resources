...
- 3.1.7 Keep it simple
    ...
    - ❄️**Zero Trust**: Security architecture where no entity is trusted by default. Based on 3 principles
        ...
        - In a zero trust network architecture,
             ...
             - 🍍The policy administrator (PA) or Policy Decision Point (PDP), on the other hand, acts based on the decisions made by the policy engine, establishing or removing communication paths and managing session-specific credentials. 
